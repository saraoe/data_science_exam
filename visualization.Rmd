...
half_relevant <- relevant %>% 
  ...
  mutate(y_pos = ifelse(resonance>=0, resonance+0.0008, resonance-0.0008),
         date = ifelse(n_event!=3, as.Date(date), as.Date(date)-4)) %>% 
...
Defining colors
```{r}
# This should be: color1,    color2,    color3,    color4
fill_colors = c("#006AFF", "#FF4B00", "#6F00FF", "#FF9800")

# This should be: color1,   color2,    color3,    color4,   color2,    color3,    color4
col_colors = c("#006AFF", "#FF4B00", "#6F00FF", "#FF9800", "#FF4B00", "#6F00FF", "#FF9800")
```
...
ggsave("test_plot.png", width=12, height=5)
```
